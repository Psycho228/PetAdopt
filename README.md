...
- 📝 **Умный опросник** — 6 разделов, 37 вопросов с современными UI-компонентами (выпадающие списки, чекбоксы, анимации)
...
### Опросник (обновлён)
- Пошаговая навигация по 6 разделам
...
- [x] Улучшенный опросник с Material 3 UI
  - Выпадающие списки вместо кастомных меню
  - Чекбоксы для множественного выбора
  - Анимации переходов и прогресс-бар
  - Пошаговая навигация по разделам
- [x] Управление заявками:
  - Список заявок на питомца со статистикой
  - Детальный экран заявки с полной информацией
  - Отображение оценки рисков (GigaChat)
  - Кнопки "Подтвердить"/"Отклонить" с диалогами
